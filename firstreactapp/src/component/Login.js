...
return(
  ...
  <form>
   <div class="col-md-4">
       ...
       <input type="text" class="form-control" id="uid"name="uid"onChange={this.handleChange}required/>

   </div>
   <div class="col-md-4">
       <label className="lb"  for="password">Password</label>
       <input type="password" class="form-control" name="pwd" id="pwd"onChange={this.handleChange}required/>
   </div>
   <br/>
   <button type="submit" class="btn btn-primary col-md-4"onClick={this.submitInfo}>Sign In</button>
   </form>
