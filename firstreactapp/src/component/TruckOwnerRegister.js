  ...
  {/* <h1 className="header">Customer Registration</h1><br/>*/}
   ...
   <form>
       ...
       <div className="form-group" class="col-md-4">
           ...
           <div className="form-group" class="col-md-4">
           <label  className="lb"   for="source">Enter Source :</label>
           <input type="text" id="source" className="form-control" name="source"onChange={this.handleChange} />
           </div>

       <div className="form-group"class="col-md-4">
       <label  className="lb"   for="destination"> Enter Destination :</label>
       <input type="text" id="destination" className="form-control" name="destination"onChange={this.handleChange} />
       </div>

       <div className="form-group"class="col-md-4">
       <label  className="lb"   for="contact"> Enter Contact :</label>
       <input type="text" id="contact" className="form-control" name="contact"onChange={this.handleChange} />
       </div>


       <div className="form-group" class="col-md-4">
           <label  className="lb"   for="availability_status">Enter Availability status :</label>
           <input type="text" id="availability_status" className="form-control" name="availability_status"onChange={this.handleChange} />
           </div><br/>
